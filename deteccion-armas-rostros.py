...
while True:
    ...
    # Implement frame skipping (process every second frame)
    frame_skip += 1
    if frame_skip % 2 != 0:
        continue  # Skip this frame

    # Reset frame skip counter and time tracking
    frame_skip = 0
    ...
    # Draw rectangles around detected faces (green color)
    for (x, y, w, h) in faces:
        cv2.rectangle(img, (x, y), (x+w, y+h), (0, 255, 0), 2)

    # Drawing boxes and labels for weapons
